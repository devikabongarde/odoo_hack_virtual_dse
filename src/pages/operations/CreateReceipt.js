...
const CreateReceipt = () => {
  const [formData, setFormData] = useState({
    reference: 'WH/IN/0003', // Auto-generated
    from: '',
    to: '',
    contact: '',
    scheduleDate: ''
  ...
  const fromOptions = ['vendor', 'supplier', 'partner'];
  const toOptions = ['WH/Stock1', 'WH/Stock2', 'WH/Main'];
  const contactOptions = ['Azure Interior', 'Tech Solutions', 'Fashion World'];
